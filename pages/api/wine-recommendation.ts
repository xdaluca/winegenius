...
export default async function handler(
  ...
  let basePrompt = `As a sommelier, recommend 5 wines to pair with ${dish} based on these preferences: ${preferences}. Include a brief description and a reason for recommending each wine.`;
